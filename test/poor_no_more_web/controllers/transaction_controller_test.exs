defmodule PoorNoMoreWeb.TransactionControllerTest do
  use PoorNoMoreWeb.ConnCase

  alias PoorNoMore.Expenses

  @create_attrs %{amount: "120.5", category: "some category", description: "some description", merchant: "some merchant", name: "some name"}
